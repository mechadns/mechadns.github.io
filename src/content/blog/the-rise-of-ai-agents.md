...
They use reasoning to decide what to do next, not fixed logic. Google Cloud defines agents as “intelligent assistants that complete multi-step tasks by combining reasoning, planning, memory, and action” [[1]](#references).
...
IBM ties the rise of AI agents to their deepening understanding of context and autonomy [[2]](#references).
...
Open-source developers are even building ecosystems where multiple agents collaborate on bigger goals [[3]](#references).
...
According to Microsoft CTO Kevin Scott, agent usage has more than doubled since last year [[4]](#references).

## Healthy Skepticism

Some developers remain cautious. As one Reddit user pointed out, agents can hallucinate, fail silently, or loop endlessly. These issues make reliability a top concern [[5]](#references).
...
1. [Google Cloud – What are AI Agents?](https://cloud.google.com/discover/what-are-ai-agents)  
2. [IBM – AI Agents: A New Era of Automation](https://www.ibm.com/think/ai-agents)  
3. [Louis Bouchard – The Year of AI Agents](https://www.louisbouchard.ai/the-year-of-ai-agents/)  
4. [Microsoft Build 2025 – The Age of AI Agents](https://blogs.microsoft.com/blog/2025/05/19/microsoft-build-2025-the-age-of-ai-agents-and-building-the-open-agentic-web/)  
5. [Reddit – Why I’m Betting Against AI Agents in 2025](https://www.reddit.com/r/programming/comments/1m46lfb/why_im_betting_against_ai_agents_in_2025_despite/)
